...
function CardExpenseComparison(props) {
    ...
    const { data } = props;
    const expenseData = (<div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
        {data.map((item, index) => (
            <div key={index} className="flex flex-col bg-white rounded-lg p-2">
                <div className="bg-gray-50 p-4 rounded-lg flex flex-col justify-between h-full">
